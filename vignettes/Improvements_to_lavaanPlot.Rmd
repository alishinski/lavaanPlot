...
```{r}
lavaanPlot2(fit, include = "covs", labels = labels, graph_options = list(label = "my first graph"), node_options = list( fontname = "Helvetica"), edge_options = list(color = "grey"), stars = c("regress"), coef_labels = TRUE)

lavaanPlot2(fit2, include = "covs", labels = labels2, graph_options = list(label = "my first graph"), node_options = list( fontname = "Helvetica"), edge_options = list(color = "grey"), stars = c("latent"), coef_labels = TRUE)
